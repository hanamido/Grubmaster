function showform(dowhat) {
    ...
    */
    if (dowhat == 'insert'){
        ...
        document.getElementById('update-cuisine').style.display = 'none'; 
    }
    else if (dowhat == 'update'){
        document.getElementById('search-cuisine').style.display = 'none';
        document.getElementById('browse-cuisines').style.display = 'block';
        document.getElementById('add-cuisine').style.display = 'none';
        document.getElementById('update-cuisine').style.display = 'block';
    }
    else if (dowhat == 'all'){
...
function updateCuisine() { showform('update'); }
